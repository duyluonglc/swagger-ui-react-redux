...
class ObjectModel extends Component {
  render () {
    let { schema, name, isRef, getComponent, depth } = this.props
...
class Model extends Component {
  constructor (props, context) {
    ...
    this.getRefSchema = this.getRefSchema.bind(this)
  }
  ...
  render () {
    return (<span>
      <span onClick={this.toggleCollapsed} style={{ 'cursor': 'pointer' }}>
        <span className={'model-toggle' + (this.state.collapsed ? ' collapsed' : '')} />
      </span>
